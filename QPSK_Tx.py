...
class QPSK_Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qpsk_obj = qpsk_obj = digital.constellation_rect([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_b([0x33] * 1000, True, 1, [])
