...
class chanel_effect(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "chanel_effect")
...
def main(top_block_cls=chanel_effect, options=None):
