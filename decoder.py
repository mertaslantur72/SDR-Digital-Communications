...
class decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "decoder")
        ...
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.digital_constellation_encoder_bc_0_0, 0))
        ...
        self.connect((self.digital_constellation_encoder_bc_0_0, 0), (self.blocks_throttle2_0, 0))
...
def main(top_block_cls=decoder, options=None):
