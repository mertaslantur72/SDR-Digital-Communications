...
class iki_kaynak_noise(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "iki_kaynak_noise")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 4000, 0.7, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 1000, 0.7, 0, 0)
...
def main(top_block_cls=iki_kaynak_noise, options=None):
