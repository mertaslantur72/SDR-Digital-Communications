...
class plus_shaping(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "plus_shaping")
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(sps, firdes.root_raised_cosine(sps, samp_rate * sps, samp_rate, 0.35, 11 * sps))
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc([-1, 1], 2)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.interp_fir_filter_xxx_0.set_taps(firdes.root_raised_cosine(self.sps, self.samp_rate * self.sps, self.samp_rate, 0.35, 11 * self.sps))
        self.qtgui_eye_sink_x_0.set_samp_rate(self.samp_rate*self.sps)
...
def main(top_block_cls=plus_shaping, options=None):
